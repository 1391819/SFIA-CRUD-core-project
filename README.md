...
1. Full commitment to an Agile approach, including daily stand-up meetings and utilisation of Sprints, user stories, acceptance criteria, story points, and effective communication within the team. 
2. A Kanban board with full expansion on user stories and tasks needed to complete the project, along with a record of any issues or risks encountered during project creation. 
3. Code integrated into a central repository on a Version Control System, utilizing issues, pull requests, merge requests, and any other aspects deemed appropriate. 
4. You should consider the concept of MVP (Minimum Viable Product) as you plan your project.  
5. Ensure that you complete all the Client requirements before adding extra functionality that is not explicitly specified. 
...
### Extra
- In addition to the requirements above, the website should maintain a uniform look and feel across all pages. 
...
All of these are deemed as 'essential' components and should be part of your Minimum Viable Product (MVP). 
Complete them as soon as possible and then consider adding 'desirable' features. 
